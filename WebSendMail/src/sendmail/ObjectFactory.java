 ...
 * generated in the sendmail package. 
...
public class ObjectFactory {
    ...
    private final static QName _SendEmail_QNAME = new QName("http://sendmail/", "sendEmail");
    private final static QName _ValidateEmailAddressResponse_QNAME = new QName("http://sendmail/", "validateEmailAddressResponse");
    private final static QName _SendEmailResponse_QNAME = new QName("http://sendmail/", "sendEmailResponse");
    private final static QName _ValidateEmailAddress_QNAME = new QName("http://sendmail/", "validateEmailAddress");
    private final static QName _SendEmailBatch_QNAME = new QName("http://sendmail/", "sendEmailBatch");
    private final static QName _SendEmailBatchResponse_QNAME = new QName("http://sendmail/", "sendEmailBatchResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: sendmail
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://sendmail/", name = "sendEmail")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://sendmail/", name = "validateEmailAddressResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://sendmail/", name = "sendEmailResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://sendmail/", name = "validateEmailAddress")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://sendmail/", name = "sendEmailBatch")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://sendmail/", name = "sendEmailBatchResponse")
